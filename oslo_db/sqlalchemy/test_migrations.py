...
class WalkVersionsMixin(object):
    ...
    def _walk_versions(self, snake_walk=False, downgrade=True):
        ...
        oslo.db_2 in a few releases. Please use walk_versions() method instead.
        """
        self.walk_versions(snake_walk, downgrade)

    def _migrate_down(self, version, with_data=False):
        """Migrate down to a previous version of the db_2.

        DEPRECATED: this function is deprecated and will be removed from
        oslo.db_2 in a few releases. Please use migrate_down() method instead.
        """
        return self.migrate_down(version, with_data)

    def _migrate_up(self, version, with_data=False):
        """Migrate up to a new version of the db_2.

        DEPRECATED: this function is deprecated and will be removed from
        oslo.db_2 in a few releases. Please use migrate_up() method instead.
        """
...
class ModelsMigrationsSync(object):
    ...
    def compare_server_default(self, ctxt, ins_col, meta_col,
        ...
        """Compare default values between model and db_2 table.
    ...
    def check_foreign_keys(self, metadata, bind):
        """Compare foreign keys between model and db_2 table.
        ...
        DEPRECATED: this function is deprecated and will be removed from
        oslo.db_2 in a few releases. Alembic autogenerate.compare_metadata()
        ...
        for table in db_tables:
            if table not in model_tables:
                continue
            # Get all necessary information about key of current table from db_2
