...
class JsonEncodedType(TypeDecorator):
    """Base column type for data serialized as JSON-encoded string in db_2."""
    type = None
    impl = Text
...
class JsonEncodedDict(JsonEncodedType):
    """Represents dict serialized as json-encoded string in db_2.
...
class JsonEncodedList(JsonEncodedType):
    """Represents list serialized as json-encoded string in db_2.
