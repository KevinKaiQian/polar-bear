...
# copy from glance/db_2/sqlalchemy/api.py
def paginate_query(query, model, limit, sort_keys, marker=None,
    ...
    marker, then the actual marker object must be fetched from the db_2 and
...
def model_query(model, session, args=None, **kwargs):
    """Query helper for db_2.sqlalchemy api methods.
...
def get_table(engine, name):
    """Returns an sqlalchemy table dynamically from db_2.
