...
def retry_on_deadlock(f):
    ...
    wrap_db_entry will be applied to all db_2.api functions marked with this
    decorator.
    """
...
class wrap_db_retry(object):
    """Retry db_2.api methods, if db_error raised

    Retry decorated db_2.api methods. This decorator catches db_error and retries
